...
describe("Helm", function()
	...
	describe("handleWindowCreated", function()
		...
		describe("focusLeft and focusRight with columns", function()
			it("should navigate based on column order", function()
				local win10 = mock.addMockWindow(10, true)
				local win20 = mock.addMockWindow(20, true)
				local win30 = mock.addMockWindow(30, true)
				...
				Helm.windowColumnMap = { [30] = 1, [10] = 2, [20] = 3 }
				Helm.activeSpaceId = 1
				Helm.columns = Helm.spaces[1].columns
				...
				assert.are.equal(30, focusedId, "focusLeft from middle column should go to left column")
				...
				assert.are.equal(20, focusedId, "focusRight from middle column should go to right column")
				...
				assert.are.equal(10, focusedId, "focusRight from left column should go to middle column")
			end)
		end)
	end)
end)
